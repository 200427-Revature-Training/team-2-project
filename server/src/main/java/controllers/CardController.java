...
import entities.ReactCard;

import models.NewPost;

import models.ReactTicketModel;

import models.TicketUpdate;
...
/* START POST METHOD*/
	...
	public ReactTicketModel save(@RequestBody ReactTicketModel post) {

		System.out.println("new post request received");

		Card dbpost = cardService.saveNew(post); //grab received data as new card, then use it as an arg for method in cardService
